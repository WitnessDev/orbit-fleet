...
export const DEFAULT_ROLE_DEFINITIONS: RoleDefinition[] = [
  {
    ...
    name: "admin",
    label: "Admin",
    description: "Full system control, billing, user access, and fleet configuration.",
    colorVariant: "purple",
  ...
  },
  {
    ...
    name: "owner",
    label: "Owner",
    description: "Executive oversight of all company assets, financial telemetry, and security.",
  ...
  },
  {
    ...
    name: "fleet_manager",
    label: "Fleet Manager",
    description: "Operational supervisor overseeing vehicle assignments, maintenance, and routes.",
    colorVariant: "blue",
    permissions: [
      "perm_view_vehicles",
  ...
  },
  {
    ...
    name: "driver",
    label: "Driver",
    description: "Vehicle operator with access to assigned vehicle trips and live route navigation.",
    colorVariant: "slate",
  ...
  },
  {
    ...
    name: "viewer",
    label: "Viewer",
    description: "Read-only access to view vehicle statuses and generated summary reports.",
    colorVariant: "amber",
    permissions: ["perm_view_vehicles", "perm_view_trips"],
  },
];
...
const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    department: "Port Authority Audits",
    createdAt: "2026-03-01T12:00:00.000Z",
    lastLogin: "Yesterday",
    notes: "Port clearance compliance inspector",
  },
  {
    id: "usr-008",
    name: "Juma Hassan",
